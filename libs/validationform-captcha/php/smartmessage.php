                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Guest name:</span> '.$_POST["guestname"].'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Contact email:</span> '.$_POST["guestemail"].'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Telephone number:</span> '.$_POST["guestelephone"].'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Adult guests:</span> '.$_POST["adults"].'</p>
														<p><span style="font-weight:bold;font-size:16px">Child guests:</span> '.$_POST["children"].'</p>
														<p><span style="font-weight:bold;font-size:16px">Check-in date:</span> '.$_POST["checkin"].'</p>
														<p><span style="font-weight:bold;font-size:16px">Check-out date:</span> '.$_POST["checkout"].'</p>
                                                        <p><span style="font-weight:bold;font-size:16px;">Question or comment below:</span> </p>
                                                        <p style="margin-bottom:0;"> '.$_POST["comment"].' </p>
