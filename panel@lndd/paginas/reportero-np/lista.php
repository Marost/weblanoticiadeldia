...
// Data Gathering
$params['sql_query']                = "SELECT id,titulo,fecha_publicacion FROM ".$tabla_suf."_noticia WHERE categoria=7 AND publicar=0 ORDER BY fecha_publicacion DESC, id DESC";
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Reportero Ciudadano - NO PUBLICADOS</span>
    </div>
