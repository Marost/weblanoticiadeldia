...
// Data Gathering
$params['sql_query']                = "SELECT id,titulo FROM ".$tabla_suf."_blog ORDER BY titulo DESC, id DESC";
...
$arr_extra_cols[0]  = array(6,'Acciones','100','<div class="btn-group" style="display: inline-block; margin-bottom: -4px;">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    <li><a href="../blog-noticias/lista.php?not=#COL1#" class="">
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Blog</span>
    </div>
