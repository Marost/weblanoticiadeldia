...
$arr_extra_cols[0]  = array(6,'Acciones','100','<div class="btn-group" style="display: inline-block; margin-bottom: -4px;">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li>
                                        <a onclick="eliminarRegistro(#COL1#, '.$reqId.');" href="javascript:;">
...
function eliminarRegistro(registro, blog) {
    if(confirm("¿Está seguro de borrar este registro?")) {
        document.location.href="s-eliminar.php?id="+registro+"&not="+blog;
    }
}
</script>
</head>
