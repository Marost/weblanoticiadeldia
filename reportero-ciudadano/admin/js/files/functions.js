$(function() {
	...
	$("#uploader").pluploadQueue({
		...
		url : '/reportero-ciudadano/admin/php/upload.php',
		max_file_size : '100mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
		resize: {width: 900, height: 900, quality: 90},
		filters : [
	...
	$("#uploader_columnista").pluploadQueue({
		runtimes : 'html5,html4',
		url : '/reportero-ciudadano/admin/php/upload_columnista.php',
		max_file_size : '100mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
	...
	$("#uploader_columnista_cuerpo").pluploadQueue({
		runtimes : 'html5,html4',
		url : '/reportero-ciudadano/admin/php/upload_columnista_cuerpo.php',
		max_file_size : '100mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
	...
	$("#uploader_pdf").pluploadQueue({
		runtimes : 'html5,html4',
		url : '/reportero-ciudadano/admin/php/upload_pdf.php',
		max_file_size : '200mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
	...
	$("#uploader_video").pluploadQueue({
		runtimes : 'html5,html4',
		url : '/reportero-ciudadano/admin/php/upload_video.php',
		max_file_size : '500mb',
		chunk_size : '1mb',
		unique_names : true,
		dragdrop: false,
