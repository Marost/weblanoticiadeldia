...
// Data Gathering
$params['sql_query']                = "SELECT id,titulo,publicar FROM ".$tabla_suf."_noticia WHERE usuario='$usuario_user' ORDER BY fecha_publicacion DESC, id DESC";
...
$params['header']                   = 'ID,Registro,Publicado';
$params['width']                    = '30,650,100';
...
<div id="content">
    <div class="contentTop">
        ...
        <span class="pageTitle"><span class="icon-pencil"></span><a href="f-agregar.php">Agregar noticia</a></span>
    </div>
