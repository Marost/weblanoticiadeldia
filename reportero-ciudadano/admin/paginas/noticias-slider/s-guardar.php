...
if($num_notgaleria>0){
	...
	while($_POST['uploader_'.$cont.'_tmpname']<>""){
		...
		$thumb{$cont}->cropFromCenter(870,500);
		$thumb{$cont}->save("../../../../imagenes/upload/".$imagen_carpeta."".$imagen."", "jpg");

		//THUMB
		$thumb{$cont}=PhpThumbFactory::create("../../../../imagenes/upload/".$imagen_carpeta."".$imagen."");
		$thumb{$cont}->cropFromCenter(570,460);
		$thumb{$cont}->save("../../../../imagenes/upload/".$imagen_carpeta."thumb/".$imagen."", "jpg");

		//GALERIA
		$thumb{$cont}=PhpThumbFactory::create("../../../../imagenes/upload/".$imagen_carpeta."".$imagen."");
		$thumb{$cont}->adaptiveResize(110,110);
		$thumb{$cont}->save("../../../../imagenes/upload/".$imagen_carpeta."galeria/".$imagen."", "jpg");
