...
//NOTICIA DESTACADA
$rst_not_dest=mysql_query("SELECT * FROM lndd_noticia WHERE destacada=1 AND publicar=1 AND fecha_publicacion<='$fechaActual' ORDER BY fecha_publicacion DESC, id DESC LIMIT 1", $conexion);
...
<div class="posts col-lg-9 col-md-9 col-sm-12">
	...
	<div class="row">
		...
		<div class="row col-lg-8 col-md-8 col-sm-8 mrbt0">
			
			<!-- POST SLIDER -->
			<div class="post-slider slider-home col-lg-12 col-md-12 col-sm-12">
				...
				<div class="slides">
					<?php while($fila_not_dest=mysql_fetch_array($rst_not_dest)){
							...
							$notDest_web_img=$web."imagenes/upload/".$notDest_imagen_carpeta."".$notDest_imagen;
		...
		<div class="row col-lg-4 mr0-pd0">

			<!-- NOTICIA CENTRAL -->
			<article class="col-md-12 col-sm-12 mid">
